...
- Pendiente: SMTP real para contrasenas temporales, rollback para Media/sitio si se requiere, publicación versionada draft/publish, upload real de Media con storage binario, cache incremental, query executor contextual, outbox real, idempotencia runtime, persistencia local y empaquetado nativo.
